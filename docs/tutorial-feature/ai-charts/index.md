...
![ai-conversation-create.png](./ai-conversation-create.png)

![ai-conversation-other-op.png](./ai-conversation-other-op.png)
...
![ai-conversation-user-message-op.png](ai-conversation-user-message-op.png)

Assistant messages can be copied, regenerated, and saved as files.

![ai-conversation-assistant-message-op.png](ai-conversation-assistant-message-op.png)

Code content within a message can be copied or generate  file.

![ai-conversation-code-op.png](ai-conversation-code-op.png)
